...
* 再创建一个实现产品类A，B
```java
public class CreateProductA extends AbstractProductA{
...
```
```java
public class CreateProductB extends AbstractProductB{
...
* 创建一个实现工厂类
```java
public class CreateFactoryA extends Factory{
...
public class AbstractFactoryDemo {
	...
	public static void main(String[] args) {
		Factory factory = new CreateFactoryA();
